			...
			<div class="row">
				<div class="col-12">
					<div class="card card-primary">
						...
						<form action="{{ route('blog.update', $data->id) }}" id="blogform" class="formaction" data-action="redirect">
							@csrf
							@method('PATCH')
							<div class="card-body row">
								<div class="form-group col-md-12 col-12 text-center mb-4">
									<img height="200" class="rounded" src="{{ getImage($data->image) }}" />
								</div>
								<div class="form-group col-md-4 col-12">
									<label class="required">image</label>
									<input type="file" name="blog_image" class="form-control " placeholder="Category Image" accept=".jpg, .jpeg, .png, .svg, .webp">
								</div>

								<div class="form-group col-md-4 col-12">
									<label class="required">Title</label>
									<input type="text" name="title" value="{{ $data->title }}" class="form-control required" placeholder="Title">
								</div>

								<div class="form-group col-md-4 col-12">
									<label class="required">Background color</label>
									<input type="color" name="background_color" value="{{ $data->background_color }}" class="form-control" placeholder="Background color">
								</div>
