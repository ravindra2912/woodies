      ...
      <div class="row">
        ...
        <div class="col-md-6 col-sm-10">
          <div class="card card-primary">
            ...
            <input type="hidden" id="form_url" value="{{ route('faq.update',$faq->id) }}">
            <div class="card-body">

              <div class="form-group">
                <label class="required">Question</label>
                <input type="text" name="question" id="question" value="{{ $faq->question }}" class="form-control" placeholder="Question" required>
              </div>

              <div class="form-group ">
                <label class="">Answer</label>
                <textarea class="form-control" name="answer" id="answer" placeholder="Answer">{{ $faq->answer }}</textarea>
              </div>
      ...
      $.ajax({
        ...
        success: function(result) {
          if (result.success) {
            ...
            setTimeout(function() {
              window.location.href = window.location.origin + '/seller/faq'
            }, 2000);
          } else {
