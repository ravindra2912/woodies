...
@section('seo')
		...
		@php
			$description = 'Bajarang Shipping Method';
			$keywords = 'Shipping Method';
		@endphp

		<title>Bajarang | Shipping Method</title>
	    ...
	    <meta name="DC.title" content="Shipping Method">
	    ...
	    <meta property="twitter:title" content="Shipping Method">
...
@section('content')
	...
	<section id="nevigation-header">
		...
		<p>Home <i class="fa-solid fa-angle-right"></i> Shipping Method</p>
	</section>
  ...
  <section id="about" class="mt-5 mb-5 pb-5">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-12">
					<h4 class="font-weight-bold">Cash & Carry</h4>
			...
			<div class="row flex-row-reverse">
				...
				<div class="col-lg-6 col-md-6 col-12">
					<h4 class="font-weight-bold">Pick-up-Point Locator</h4>
					<p class="h5 mt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi euismod, sed porta est consectetur deserunt.</p>
					<p class="mt-5">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
				</div>
				<div class="col-lg-12 col-md-12 col-12 m-hide">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-12">
					<h4 class="font-weight-bold">Door-to-door shipping service</h4>
					<p class="h5 mt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi euismod, sed porta est consectetur deserunt.</p>
					<p class="mt-5">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
				</div>
				<div class="col-lg-12 col-md-12 col-12 m-hide">
			...
			<div class="row flex-row-reverse">
				<div class="col-lg-6 col-md-6 col-12">
					<img class="iconimg" src="{{ asset('front/images/ShippingMethod/worldwide-shipping 1.png') }}" />
				</div>
				<div class="col-lg-6 col-md-6 col-12">
					<h4 class="font-weight-bold">International Parcel Delivery</h4>
					<p class="h5 mt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi euismod, sed porta est consectetur deserunt.</p>
					<p class="mt-5">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
				</div>
