...
Route::get('/cancellationpolicy', function () {
	return view('front.cancellationpolicy');
})->name('CancellationPolicy');



Route::get('/ShippingMethod', function () {
	return view('front.support.shipping');
});
Route::get('/PaymentMethod', function () {
	return view('front.support.PaymentMethod');
});
Route::get('/OrderTracking', function () {
	return view('front.support.OrderTracking');
});
...
Route::prefix('seller')->middleware(['auth', 'IsAdmin'])->group(function () {
